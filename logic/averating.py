...
from modules.stab_manager import TempBalanceManager, TempKlinesManager, TempOrdersManager
...
class Averating(BotBase):
    ...
    def __notify(self):
        ...
        min_sell_price = self.lines.read_sell_lines()[0]
        min_buy_price = self.lines.read_buy_lines()[0] 
